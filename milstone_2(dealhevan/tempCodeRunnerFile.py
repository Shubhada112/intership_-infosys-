...
def scrape_deals(store_name, category_name, start, end, csv_filename):
    ...
    with open(csv_filename, mode="w", newline="", encoding="utf-8") as file:
        ...
        for current_page in range(start, end + 1):
            ...
            if category_name == "All Categories":
                ...
                url = f"https://dealsheaven.in/category/{formatted_category}?page={current_page}"
            ...
            for item in all_items:
                ...
                writer.writerow([
                    ...
                    product.get("Image", "N/A"),
                    product.get("Price", "N/A"),
                    product.get("Discount", "N/A"),
                    product.get("Special Price", "N/A"),
